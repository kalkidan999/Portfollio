    ...
    return LayoutBuilder(builder: (context, constraints) {
      return Scaffold(
        ...
        child: Column(
          children: [
            // Header section
            Introview(constraints: constraints),
            sizedHeight(deviceSize.height * 0.1),
            //  About section
            Aboutview(constraints: constraints),
            //Experience section
            ExperienceView(constraints: constraints),
            //Education section
            EducationView(constraints: constraints),
            //Project section
            ProjectView(
              constraints: constraints,
              onPlayStoreHover: _onPlayStoreHover,
              onAppStoreHover: _onAppStoreHover,
              enteredMouseRegion: enteredMouseRegion,
              playStoreHovered: playStoreHovered,
              appStoreHovered: appStoreHovered,
